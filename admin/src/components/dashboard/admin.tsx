...
export default function Dashboard() {
	...
	return (
		<>
			...
			<div className="flex flex-wrap w-full mb-6">
				<div className="w-full mb-6 sm:w-1/2 xl:w-1/2 sm:px-3 sm:pl-0 xl:mb-0">
					<RecentOrders
				...
				<div className="w-full mb-6 sm:w-1/2 xl:w-1/2 sm:px-3 sm:pr-0 xl:mb-0">
					<WithdrawTable
						//@ts-ignore
			...
			<div className="w-full mb-6 sm:pe-0 xl:mb-0">
				<PopularProductList
